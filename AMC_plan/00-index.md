...
| [19-skill-evolve-trace2skill-plan.md](19-skill-evolve-trace2skill-plan.md) | Skill Evolve/Route 设计 | 复现 Trace2Skill：锚点轨迹召回、并行 patch proposal、分层合并，支持 update/create 自动路由，并新增 commit 驱动的 inter-trajectory graph 自动触发链路 |
